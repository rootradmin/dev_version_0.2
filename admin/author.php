                   ...
                   <?php
                       ...
                       //update postları finish
                        ...
                        //hidden alanlar
                            ...
                            $authorsa  = mysql_real_escape_string($_POST['authorsa']);
                            $autpass  = mysql_real_escape_string($_POST['autpass']);
                            $autname  = mysql_real_escape_string($_POST['autname']);
                            $autsurname  = mysql_real_escape_string($_POST['autsurname']);
                       ...
                       if ($_POST['delete']) //SİL BUTONUNA BASILDIĞINDA İD'Sİ GELEN DEĞERİ SİL
                        ...
                        <div class="six columns" align="center" style="background-color: darkgray;">
                            <h2>Yazar Güncelle</h2>
                               <form method="post">
                                   <input type="hidden">
                                   <input  name="newusername" value="<?php echo $authorsa;?>" type="text"    class="ten columns"  placeholder="NEW USERNAME">
                                   <input  name="newpass"     value="<?php echo $autpass;?>" type="password" class="ten columns"  placeholder="NEW PASSWORD">
                                   <input  name="newname"     value="<?php echo $autname;?>" type="text"     class="ten columns"  placeholder=" NEW NAME">
                                   <input  name="newsurname"  value="<?php echo $autsurname;?>" type="text"  class="ten columns"  placeholder="NEW SURNAME">
                                   <input  name="newmail"     value="<?php echo $autmail;?>" type="email"    class="ten columns"  placeholder="NEW E-MAİL">
                        ...
                        <div class="twelve columns" align="center" style="background-color: darkgray">
                            ...
                            for ($number = 0; $number <= $sonuc; $number++) {
                                ...
                                while ($come = mysql_fetch_assoc($query)) {
                                    ...
                                    $autpass = $come ['a_pass'];
                                    $autname = $come ['author_name'];
                                    $autsurname = $come['author_surname'];
                                    $autmail = $come ['mail'];
                                    ...
                                    //görünmez alanlar
                                        ...
                                        echo "<input type='hidden' name='authorsa' value='$authors'>";
                                        echo "<input type='hidden' name='autpass' value='$autpass'>";
                                        echo "<input type='hidden' name='autname' value='$autname'>";
                                        echo "<input type='hidden' name='autsurname' value='$autsurname'>";
                                        echo "<input type='hidden' name='autmail' value='$autmail'>";
                                    //
